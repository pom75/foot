        ...
        <div id="container">
           ...
           <div id="nav_5">
            ...
            <div id="list">
                ...
                <input type="text" name="titre" class="titre" placeholder="Titre"/> <label for="nom"> Exemple : Foot Hériot</label>
                <br/>
                <br/>
                <input type="text" name="date" class="date" placeholder="Date"/> <label for="nom"> Exemple : Dimanche 28 à 10h30</label>
                <br/>
                <br/>
                <input type="text" name="nb" class="nb" placeholder="Nombre de participant"/> <label for="nom"> Exemple : 10</label>
                <br/>
                <br/>
                 <input name="app" type="submit"  value="Crée !" />
                </form>
