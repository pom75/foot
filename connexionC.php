    ...
    <body>
        <div id="container">
            ...
            <div id="list">
                ...
                $sql = "SELECT * FROM USER1 WHERE USER1.mdp = '".$_POST['pass']."' AND USER1.nom = '".$_POST['nom']."'";
                ...
                {	
                	...
                	setcookie("nomA",$dn['nom'],time()+6000000000);
                	setcookie("passA",$dn['mdp'],time()+6000000000);
                	setcookie("iduA",$dn['idu'],time()+6000000000);
